...
/** Hero photo — place your image at apps/web/public/hero-workers.jpg */
function HeroPhoto() {
  return (
    <div className="w-full h-full rounded-3xl overflow-hidden relative bg-violet-50">
      <img
        src="/hero-workers.jpg"
        alt="Verified Nigerian skilled workers — plumber, tailor, mechanic and electrician"
        className="w-full h-full object-cover object-top"
        draggable={false}
      />
      {/* Subtle bottom fade so text below stays legible */}
